                ...
                child:
                             ...
                             Column(
                                  ...
                                  children: [
                                          ...
                                          Container(
                                                  ...
                                                  child: Text("I told you long ago, wanna roll, i will kill you for god sake I told you long ago, wanna roll, i will kill you for god sake",
                                                  textAlign: TextAlign.left,
                                          ...
                                          Row(
                                            children: [
                                              Container(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsets.all(8.0), // Add padding to create space around the texts
                                      ...
                                      SizedBox(height: 20),
                                        ...
                                        ElevatedButton(
                                          onPressed:(){ Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => EditProfile() , // Replace with the screen you want to navigate to
                                              ),
                                            );
                                          },
                  ...
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Card(
                        color: Colors.blue,
                         shape: RoundedRectangleBorder( // Set the shape property to a RoundedRectangleBorder
                          borderRadius: BorderRadius.circular(16), // Set your desired corner radius
                        ),
                        child: ExpansionTile(
                            title: Text("More details", style: TextStyle(color: Colors.white),),
                            leading: Icon(CupertinoIcons.app, color: Colors.white,),
                            backgroundColor: Color(0xFF4137BD),
                            children: [
                              Column( // Wrap the children with a Column
                                crossAxisAlignment: CrossAxisAlignment.start,
                         ...
                         child: ElevatedButton(
                                ...
                                style: TextStyle(
                                  ...
                                  style: ButtonStyle(
                                    ...
                                    foregroundColor: MaterialStatePropertyAll(Colors.transparent),
                                    fixedSize: MaterialStatePropertyAll(Size(120,30)),
                                  shape: MaterialStateProperty.all(RoundedRectangleBorder(
                                          borderRadius: BorderRadius.circular(30.0),
