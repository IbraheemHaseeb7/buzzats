...
class HomeState extends State<Home> {
  ...
  static List<Widget> pages = <Widget>[HomeShow(),SuggestionPage(),ChatsHome(),UserProfile()];
      ...
      bottomNavigationBar: Container(
        ...
        child: Padding(
          ...
          child: GNav(
            ...
            tabs: [
              GButton(
                icon: currentPageIndex==0 ? IconlyBold.home : IconlyLight.home ,
                iconSize: 35.0,
                backgroundColor: Color(0xFF141D26),
                 onPressed: () {
                setState(() {
              ...
              GButton(
                icon: currentPageIndex==2? IconlyBold.chat :  IconlyLight.chat,
                backgroundColor: Color(0xFF141D26),
                iconSize: 35.0,
                 onPressed: () {
                setState(() {
              ...
              GButton(
                icon: currentPageIndex==3? IconlyBold.profile :  IconlyLight.profile,
                backgroundColor: Color(0xFF141D26),
                iconSize: 35.0,
                 onPressed: () {
                  setState(() {
