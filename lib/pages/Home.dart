  ...
  Widget build(BuildContext context) {
    ...
    bottomNavigationBar: Container(
      ...
      color:Color(0xFF141D26) ,
        border: Border(
          top: BorderSide(
          color: Color.fromRGBO(150, 183, 223, 1),      width: 1.0, 
          ),
    ),
      ),
      child: Padding(
    ...
    floatingActionButton: FloatingActionButton(onPressed: null,child: Icon(Icons.add),backgroundColor: Color(0xFF4137BD),),
                ...
                DrawerHeader(
                  ...
                  ListTile(
                   ...
                   child: 
                    ...
                    onTap:null ,  //this is the on pressed property of the list tile
                  ),
                    ),
                  ...
                  child: Container(
                    ...
                    width: 250,
                    padding: EdgeInsets.all(1.0), // Optional: Set padding around the text
                    decoration: BoxDecoration(
                      border: Border.all(
