...
class TotalState extends State<TotalSocieties> {
  ...
  String q = "select (select count(*) from tb_SocietyMembers mem where mem.SocietyID = soc.SocietyID) as members, soc.SocietyID,soc.PresidentID,soc.About,soc.SocietyName from tb_Society soc where soc.PresidentID = '${UserData.id}'";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("My Societies"),),
